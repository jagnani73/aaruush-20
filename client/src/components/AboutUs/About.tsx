  ...
  return (
    <div className="flex flex-wrap w-10/12 mx-auto mt-10">
      <div className="flex flex-wrap w-full">
        ...
        <div className="flex flex-wrap w-full lg:w-1/2 my-5 lg:my-auto">
      ...
      <div className="flex flex-wrap w-full mt-16 lg:mt-10">
        <div className="w-full lg:w-1/6 m-auto mb-6">
