  ...
  return (
    <div className="flex flex-wrap text-5xl w-screen h-screen bg-contactUsBG bg-center bg-no-repeat bg-cover">
      <div className="w-1/2 m-auto text-white text-center">
        <div className="w-1/2 ml-auto my-auto bg-contactUs shadow-contactUs text-base font-bold p-10">
          ...
          <div className="flex flex-wrap text-3xl w-full mx-auto mt-6">
            <a
              href="https://twitter.com/aaruushsrmist"
              target="_blank"
              rel="noopener noreferrer"
              className="flex flex-wrap w-12 h-12 mx-auto bg-twitter rounded-md"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex flex-wrap w-12 h-12 mx-auto bg-instagram rounded-md"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex flex-wrap w-12 h-12 mx-auto bg-facebook rounded-md"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex flex-wrap w-12 h-12 mx-auto bg-youtube rounded-md"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex flex-wrap w-12 h-12 mx-auto bg-linkedin rounded-md"
            >
